...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->nodynip_help = gengetopt_args_info_help[14] ;
  args_info->statip_help = gengetopt_args_info_help[15] ;
  args_info->dns1_help = gengetopt_args_info_help[16] ;
  args_info->dns2_help = gengetopt_args_info_help[17] ;
  args_info->domain_help = gengetopt_args_info_help[18] ;
  args_info->ipup_help = gengetopt_args_info_help[19] ;
  args_info->ipdown_help = gengetopt_args_info_help[20] ;
  args_info->conup_help = gengetopt_args_info_help[21] ;
  args_info->condown_help = gengetopt_args_info_help[22] ;
  args_info->txqlen_help = gengetopt_args_info_help[23] ;
  args_info->tundev_help = gengetopt_args_info_help[24] ;
  args_info->radiuslisten_help = gengetopt_args_info_help[25] ;
  args_info->radiusserver1_help = gengetopt_args_info_help[26] ;
  args_info->radiusserver2_help = gengetopt_args_info_help[27] ;
  args_info->radiusauthport_help = gengetopt_args_info_help[28] ;
  args_info->radiusacctport_help = gengetopt_args_info_help[29] ;
  args_info->radiussecret_help = gengetopt_args_info_help[30] ;
  args_info->radiustimeout_help = gengetopt_args_info_help[31] ;
  args_info->radiusretry_help = gengetopt_args_info_help[32] ;
  args_info->radiusretrysec_help = gengetopt_args_info_help[33] ;
  args_info->radiusnasid_help = gengetopt_args_info_help[34] ;
  args_info->radiuslocationid_help = gengetopt_args_info_help[35] ;
  args_info->radiuslocationname_help = gengetopt_args_info_help[36] ;
  args_info->locationname_help = gengetopt_args_info_help[37] ;
  args_info->radiusnasporttype_help = gengetopt_args_info_help[38] ;
  args_info->coaport_help = gengetopt_args_info_help[39] ;
  args_info->coanoipcheck_help = gengetopt_args_info_help[40] ;
  args_info->proxylisten_help = gengetopt_args_info_help[41] ;
  args_info->proxyport_help = gengetopt_args_info_help[42] ;
  args_info->proxyclient_help = gengetopt_args_info_help[43] ;
  args_info->proxysecret_help = gengetopt_args_info_help[44] ;
  args_info->dhcpif_help = gengetopt_args_info_help[45] ;
  args_info->dhcpmac_help = gengetopt_args_info_help[46] ;
  args_info->lease_help = gengetopt_args_info_help[47] ;
  args_info->eapolenable_help = gengetopt_args_info_help[48] ;
  args_info->uamserver_help = gengetopt_args_info_help[49] ;
  args_info->uamhomepage_help = gengetopt_args_info_help[50] ;
  args_info->uamsecret_help = gengetopt_args_info_help[51] ;
  args_info->uamlisten_help = gengetopt_args_info_help[52] ;
  args_info->uamport_help = gengetopt_args_info_help[53] ;
  args_info->uamuiport_help = gengetopt_args_info_help[54] ;
  args_info->uamallowed_help = gengetopt_args_info_help[55] ;
  args_info->uamallowed_min = -1;
  args_info->uamallowed_max = -1;
  args_info->uamdomain_help = gengetopt_args_info_help[56] ;
  args_info->uamdomain_min = -1;
  args_info->uamdomain_max = -1;
  args_info->uamanydns_help = gengetopt_args_info_help[57] ;
  args_info->uamanyip_help = gengetopt_args_info_help[58] ;
  args_info->wisprlogin_help = gengetopt_args_info_help[59] ;
  args_info->nouamsuccess_help = gengetopt_args_info_help[60] ;
  args_info->nouamwispr_help = gengetopt_args_info_help[61] ;
  args_info->uamlogoutip_help = gengetopt_args_info_help[62] ;
  args_info->defsessiontimeout_help = gengetopt_args_info_help[63] ;
  args_info->defidletimeout_help = gengetopt_args_info_help[64] ;
  args_info->definteriminterval_help = gengetopt_args_info_help[65] ;
  args_info->macauth_help = gengetopt_args_info_help[66] ;
  args_info->macallowed_help = gengetopt_args_info_help[67] ;
  args_info->macallowed_min = -1;
  args_info->macallowed_max = -1;
  args_info->macsuffix_help = gengetopt_args_info_help[68] ;
  args_info->macpasswd_help = gengetopt_args_info_help[69] ;
  args_info->macallowlocal_help = gengetopt_args_info_help[70] ;
  args_info->wwwdir_help = gengetopt_args_info_help[71] ;
  args_info->wwwbin_help = gengetopt_args_info_help[72] ;
  args_info->uamui_help = gengetopt_args_info_help[73] ;
  args_info->adminuser_help = gengetopt_args_info_help[74] ;
  args_info->adminpasswd_help = gengetopt_args_info_help[75] ;
  args_info->nasmac_help = gengetopt_args_info_help[76] ;
  args_info->nasip_help = gengetopt_args_info_help[77] ;
  args_info->ssid_help = gengetopt_args_info_help[78] ;
  args_info->vlan_help = gengetopt_args_info_help[79] ;
  args_info->cmdsocket_help = gengetopt_args_info_help[80] ;
  args_info->radiusoriginalurl_help = gengetopt_args_info_help[81] ;
  args_info->swapoctets_help = gengetopt_args_info_help[82] ;
  args_info->usestatusfile_help = gengetopt_args_info_help[83] ;
  args_info->localusers_help = gengetopt_args_info_help[84] ;
  args_info->postauthproxy_help = gengetopt_args_info_help[85] ;
  args_info->postauthproxyport_help = gengetopt_args_info_help[86] ;
  args_info->wpaguests_help = gengetopt_args_info_help[87] ;
  args_info->openidauth_help = gengetopt_args_info_help[88] ;
  args_info->papalwaysok_help = gengetopt_args_info_help[89] ;
  args_info->chillixml_help = gengetopt_args_info_help[90] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->radiustimeout_orig)
    {
      free (args_info->radiustimeout_orig); /* free previous argument */
      args_info->radiustimeout_orig = 0;
    }
  if (args_info->radiusretry_orig)
    {
      free (args_info->radiusretry_orig); /* free previous argument */
      args_info->radiusretry_orig = 0;
    }
  if (args_info->radiusretrysec_orig)
    {
      free (args_info->radiusretrysec_orig); /* free previous argument */
  ...
  if (args_info->definteriminterval_orig)
    {
      free (args_info->definteriminterval_orig); /* free previous argument */
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->radiustimeout_given) {
    if (args_info->radiustimeout_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "radiustimeout", args_info->radiustimeout_orig);
    } else {
      fprintf(outfile, "%s\n", "radiustimeout");
    }
  }
  if (args_info->radiusretry_given) {
    if (args_info->radiusretry_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "radiusretry", args_info->radiusretry_orig);
    } else {
      fprintf(outfile, "%s\n", "radiusretry");
    }
  }
  if (args_info->radiusretrysec_given) {
    if (args_info->radiusretrysec_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "radiusretrysec", args_info->radiusretrysec_orig);
    } else {
      fprintf(outfile, "%s\n", "radiusretrysec");
    }
  }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* Run in foreground.  */
          if (local_args_info.fg_given || (check_ambiguity && args_info->fg_given))
            {
        ...
        case 'c':	/* Read configuration file.  */
          if (local_args_info.conf_given || (check_ambiguity && args_info->conf_given))
            {
        ...
        case 'n':	/* Network.  */
          if (local_args_info.net_given || (check_ambiguity && args_info->net_given))
            {
        ...
        case 0:	/* Long option with no short option */
          ...
          {
            if (local_args_info.debugfacility_given || (check_ambiguity && args_info->debugfacility_given))
              {
          ...
          {
            if (local_args_info.logfacility_given || (check_ambiguity && args_info->logfacility_given))
              {
          ...
          {
            if (local_args_info.interval_given || (check_ambiguity && args_info->interval_given))
              {
          ...
          {
            if (local_args_info.pidfile_given || (check_ambiguity && args_info->pidfile_given))
              {
          ...
          {
            if (local_args_info.statedir_given || (check_ambiguity && args_info->statedir_given))
              {
          ...
          {
            if (local_args_info.dhcpstart_given || (check_ambiguity && args_info->dhcpstart_given))
              {
          ...
          {
            if (local_args_info.dhcpend_given || (check_ambiguity && args_info->dhcpend_given))
              {
          ...
          {
            if (local_args_info.dynip_given || (check_ambiguity && args_info->dynip_given))
              {
          ...
          {
            if (local_args_info.nodynip_given || (check_ambiguity && args_info->nodynip_given))
              {
                fprintf (stderr, "%s: `--nodynip' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->nodynip_given && ! override)
              continue;
            local_args_info.nodynip_given = 1;
            args_info->nodynip_given = 1;
            args_info->nodynip_flag = !(args_info->nodynip_flag);
          }
          /* Static IP address pool.  */
          else if (strcmp (long_options[option_index].name, "statip") == 0)
          {
            if (local_args_info.statip_given || (check_ambiguity && args_info->statip_given))
              {
          ...
          {
            if (local_args_info.dns1_given || (check_ambiguity && args_info->dns1_given))
              {
          ...
          {
            if (local_args_info.dns2_given || (check_ambiguity && args_info->dns2_given))
              {
          ...
          {
            if (local_args_info.domain_given || (check_ambiguity && args_info->domain_given))
              {
          ...
          {
            if (local_args_info.ipup_given || (check_ambiguity && args_info->ipup_given))
              {
          ...
          {
            if (local_args_info.ipdown_given || (check_ambiguity && args_info->ipdown_given))
              {
          ...
          {
            if (local_args_info.conup_given || (check_ambiguity && args_info->conup_given))
              {
          ...
          {
            if (local_args_info.condown_given || (check_ambiguity && args_info->condown_given))
              {
          ...
          {
            if (local_args_info.txqlen_given || (check_ambiguity && args_info->txqlen_given))
              {
          ...
          {
            if (local_args_info.tundev_given || (check_ambiguity && args_info->tundev_given))
              {
          ...
          {
            if (local_args_info.radiuslisten_given || (check_ambiguity && args_info->radiuslisten_given))
              {
          ...
          {
            if (local_args_info.radiusserver1_given || (check_ambiguity && args_info->radiusserver1_given))
              {
          ...
          {
            if (local_args_info.radiusserver2_given || (check_ambiguity && args_info->radiusserver2_given))
              {
          ...
          {
            if (local_args_info.radiusauthport_given || (check_ambiguity && args_info->radiusauthport_given))
              {
          ...
          {
            if (local_args_info.radiusacctport_given || (check_ambiguity && args_info->radiusacctport_given))
              {
          ...
          {
            if (local_args_info.radiussecret_given || (check_ambiguity && args_info->radiussecret_given))
              {
          ...
          else if (strcmp (long_options[option_index].name, "radiustimeout") == 0)
          {
            if (local_args_info.radiustimeout_given || (check_ambiguity && args_info->radiustimeout_given))
              {
                fprintf (stderr, "%s: `--radiustimeout' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->radiustimeout_given && ! override)
              continue;
            local_args_info.radiustimeout_given = 1;
            args_info->radiustimeout_given = 1;
            args_info->radiustimeout_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->radiustimeout_orig)
              free (args_info->radiustimeout_orig); /* free previous string */
            args_info->radiustimeout_orig = gengetopt_strdup (optarg);
          }
          /* Total number of retries.  */
          else if (strcmp (long_options[option_index].name, "radiusretry") == 0)
          {
            if (local_args_info.radiusretry_given || (check_ambiguity && args_info->radiusretry_given))
              {
                fprintf (stderr, "%s: `--radiusretry' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->radiusretry_given && ! override)
              continue;
            local_args_info.radiusretry_given = 1;
            args_info->radiusretry_given = 1;
            args_info->radiusretry_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->radiusretry_orig)
              free (args_info->radiusretry_orig); /* free previous string */
            args_info->radiusretry_orig = gengetopt_strdup (optarg);
          }
          /* Number of retries before using secondary.  */
          else if (strcmp (long_options[option_index].name, "radiusretrysec") == 0)
          {
            if (local_args_info.radiusretrysec_given || (check_ambiguity && args_info->radiusretrysec_given))
              {
                fprintf (stderr, "%s: `--radiusretrysec' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->radiusretrysec_given && ! override)
              continue;
            local_args_info.radiusretrysec_given = 1;
            args_info->radiusretrysec_given = 1;
            args_info->radiusretrysec_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->radiusretrysec_orig)
              free (args_info->radiusretrysec_orig); /* free previous string */
            args_info->radiusretrysec_orig = gengetopt_strdup (optarg);
          }
          /* Radius NAS-Identifier.  */
          else if (strcmp (long_options[option_index].name, "radiusnasid") == 0)
          {
            if (local_args_info.radiusnasid_given || (check_ambiguity && args_info->radiusnasid_given))
              {
          ...
          {
            if (local_args_info.radiuslocationid_given || (check_ambiguity && args_info->radiuslocationid_given))
              {
          ...
          {
            if (local_args_info.radiuslocationname_given || (check_ambiguity && args_info->radiuslocationname_given))
              {
          ...
          {
            if (local_args_info.locationname_given || (check_ambiguity && args_info->locationname_given))
              {
          ...
          {
            if (local_args_info.radiusnasporttype_given || (check_ambiguity && args_info->radiusnasporttype_given))
              {
          ...
          {
            if (local_args_info.coaport_given || (check_ambiguity && args_info->coaport_given))
              {
          ...
          {
            if (local_args_info.coanoipcheck_given || (check_ambiguity && args_info->coanoipcheck_given))
              {
          ...
          {
            if (local_args_info.proxylisten_given || (check_ambiguity && args_info->proxylisten_given))
              {
          ...
          {
            if (local_args_info.proxyport_given || (check_ambiguity && args_info->proxyport_given))
              {
          ...
          {
            if (local_args_info.proxyclient_given || (check_ambiguity && args_info->proxyclient_given))
              {
          ...
          {
            if (local_args_info.proxysecret_given || (check_ambiguity && args_info->proxysecret_given))
              {
          ...
          {
            if (local_args_info.dhcpif_given || (check_ambiguity && args_info->dhcpif_given))
              {
          ...
          {
            if (local_args_info.dhcpmac_given || (check_ambiguity && args_info->dhcpmac_given))
              {
          ...
          {
            if (local_args_info.lease_given || (check_ambiguity && args_info->lease_given))
              {
          ...
          {
            if (local_args_info.eapolenable_given || (check_ambiguity && args_info->eapolenable_given))
              {
          ...
          {
            if (local_args_info.uamserver_given || (check_ambiguity && args_info->uamserver_given))
              {
          ...
          {
            if (local_args_info.uamhomepage_given || (check_ambiguity && args_info->uamhomepage_given))
              {
          ...
          {
            if (local_args_info.uamsecret_given || (check_ambiguity && args_info->uamsecret_given))
              {
          ...
          {
            if (local_args_info.uamlisten_given || (check_ambiguity && args_info->uamlisten_given))
              {
          ...
          {
            if (local_args_info.uamport_given || (check_ambiguity && args_info->uamport_given))
              {
          ...
          {
            if (local_args_info.uamuiport_given || (check_ambiguity && args_info->uamuiport_given))
              {
          ...
          {
            if (local_args_info.uamanydns_given || (check_ambiguity && args_info->uamanydns_given))
              {
          ...
          {
            if (local_args_info.uamanyip_given || (check_ambiguity && args_info->uamanyip_given))
              {
          ...
          {
            if (local_args_info.wisprlogin_given || (check_ambiguity && args_info->wisprlogin_given))
              {
          ...
          {
            if (local_args_info.nouamsuccess_given || (check_ambiguity && args_info->nouamsuccess_given))
              {
          ...
          {
            if (local_args_info.nouamwispr_given || (check_ambiguity && args_info->nouamwispr_given))
              {
          ...
          {
            if (local_args_info.uamlogoutip_given || (check_ambiguity && args_info->uamlogoutip_given))
              {
          ...
          {
            if (local_args_info.defsessiontimeout_given || (check_ambiguity && args_info->defsessiontimeout_given))
              {
          ...
          {
            if (local_args_info.defidletimeout_given || (check_ambiguity && args_info->defidletimeout_given))
              {
          ...
          {
            if (local_args_info.definteriminterval_given || (check_ambiguity && args_info->definteriminterval_given))
              {
                fprintf (stderr, "%s: `--definteriminterval' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->definteriminterval_given && ! override)
              continue;
            local_args_info.definteriminterval_given = 1;
            args_info->definteriminterval_given = 1;
            args_info->definteriminterval_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->definteriminterval_orig)
              free (args_info->definteriminterval_orig); /* free previous string */
            args_info->definteriminterval_orig = gengetopt_strdup (optarg);
          }
          /* Authenticate based on MAC address.  */
          else if (strcmp (long_options[option_index].name, "macauth") == 0)
          {
            if (local_args_info.macauth_given || (check_ambiguity && args_info->macauth_given))
              {
          ...
          {
            if (local_args_info.macsuffix_given || (check_ambiguity && args_info->macsuffix_given))
              {
          ...
          {
            if (local_args_info.macpasswd_given || (check_ambiguity && args_info->macpasswd_given))
              {
          ...
          {
            if (local_args_info.macallowlocal_given || (check_ambiguity && args_info->macallowlocal_given))
              {
          ...
          {
            if (local_args_info.wwwdir_given || (check_ambiguity && args_info->wwwdir_given))
              {
          ...
          {
            if (local_args_info.wwwbin_given || (check_ambiguity && args_info->wwwbin_given))
              {
          ...
          {
            if (local_args_info.uamui_given || (check_ambiguity && args_info->uamui_given))
              {
          ...
          {
            if (local_args_info.adminuser_given || (check_ambiguity && args_info->adminuser_given))
              {
          ...
          {
            if (local_args_info.adminpasswd_given || (check_ambiguity && args_info->adminpasswd_given))
              {
          ...
          {
            if (local_args_info.nasmac_given || (check_ambiguity && args_info->nasmac_given))
              {
          ...
          {
            if (local_args_info.nasip_given || (check_ambiguity && args_info->nasip_given))
              {
          ...
          {
            if (local_args_info.ssid_given || (check_ambiguity && args_info->ssid_given))
              {
          ...
          {
            if (local_args_info.vlan_given || (check_ambiguity && args_info->vlan_given))
              {
          ...
          {
            if (local_args_info.cmdsocket_given || (check_ambiguity && args_info->cmdsocket_given))
              {
          ...
          {
            if (local_args_info.radiusoriginalurl_given || (check_ambiguity && args_info->radiusoriginalurl_given))
              {
          ...
          {
            if (local_args_info.swapoctets_given || (check_ambiguity && args_info->swapoctets_given))
              {
          ...
          {
            if (local_args_info.usestatusfile_given || (check_ambiguity && args_info->usestatusfile_given))
              {
          ...
          {
            if (local_args_info.localusers_given || (check_ambiguity && args_info->localusers_given))
              {
          ...
          {
            if (local_args_info.postauthproxy_given || (check_ambiguity && args_info->postauthproxy_given))
              {
          ...
          {
            if (local_args_info.postauthproxyport_given || (check_ambiguity && args_info->postauthproxyport_given))
              {
          ...
          {
            if (local_args_info.wpaguests_given || (check_ambiguity && args_info->wpaguests_given))
              {
          ...
          {
            if (local_args_info.openidauth_given || (check_ambiguity && args_info->openidauth_given))
              {
          ...
          {
            if (local_args_info.papalwaysok_given || (check_ambiguity && args_info->papalwaysok_given))
              {
          ...
          {
            if (local_args_info.chillixml_given || (check_ambiguity && args_info->chillixml_given))
              {
          ...
          {
            if (local_args_info.acctupdate_given || (check_ambiguity && args_info->acctupdate_given))
              {
          ...
          {
            if (local_args_info.dnsparanoia_given || (check_ambiguity && args_info->dnsparanoia_given))
              {
                fprintf (stderr, "%s: `--dnsparanoia' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->dnsparanoia_given && ! override)
              continue;
            local_args_info.dnsparanoia_given = 1;
            args_info->dnsparanoia_given = 1;
            args_info->dnsparanoia_flag = !(args_info->dnsparanoia_flag);
          }
          /* Use a TAP instead of TUN (linux only).  */
          else if (strcmp (long_options[option_index].name, "usetap") == 0)
          {
            if (local_args_info.usetap_given || (check_ambiguity && args_info->usetap_given))
              {
