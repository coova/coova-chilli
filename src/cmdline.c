            ...
            while (1)
              {
                ...
                uamallowed_new->uamallowed_arg = gengetopt_strdup (multi_token);
                uamallowed_new->uamallowed_orig = multi_token;
            ...
            while (1)
              {
                ...
                macallowed_new->macallowed_arg = gengetopt_strdup (multi_token);
                macallowed_new->macallowed_orig = multi_token;
